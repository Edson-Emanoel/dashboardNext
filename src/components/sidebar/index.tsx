...
import { Home, LogOut, MenuIcon, Package, Settings2, ShoppingBag, Users } from "lucide-react";
                  ...
                  <nav className="flex flex-col items-center gap-4 px-2 py-5">
                        <TooltipProvider>             
                              ...
                              <Tooltip>
                                    ...
                                    <TooltipContent side="left">Usuarios</TooltipContent>
                              </Tooltip>
                        ...
                        <Sheet>
                              ...
                              <SheetContent side="left" className="sm:max-w-x">
                                    <nav className="grid gap-6 text-lg font-medium">
                                          ...
                                          <Link
                                                href="#"
                                                className="flex items-center gap-4 text-center px-2.5 text-muted-foreground hover:text-foreground"    
                                                prefetch={false}
                                          >
